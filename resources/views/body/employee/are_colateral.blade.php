        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-capitalize">{{ __('Are colateral') }}</li>
                </ol>
            </nav>
        </div>
                                ...
                                @can('Personal_information access')
                                    <thead class="text-capitalize">
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('For Whom Full Name') }}</th>
                                    ...
                                    <tbody>
                                        @foreach ($test as $test)
                                            <tr>
                                                ...
                                                <td>{{ $test->ac_full_name }}</td>
                                                <td>{{ $test->ac_relationship }}</td>
                                                <td>{{ $test->ac_state }}</td>
                                                <td>{{ $test->ac_city }}</td>
                                                <td>{{ $test->ac_kebele }}</td>
