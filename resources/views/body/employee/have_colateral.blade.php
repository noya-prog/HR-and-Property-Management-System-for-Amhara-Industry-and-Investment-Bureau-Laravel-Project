        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-capitalize">{{ __('Have colateral') }}</li>
                </ol>
            </nav>
        </div>
                                ...
                                @can('Personal_information access')
                                    <thead class="text-capitalize">
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('Colateral Full Name') }}</th>
                                            <th scope="col">{{__('Company Name')}}</th>
                                            <th scope="col">{{ __('State') }}</th>
                                            <th scope="col">{{ __('City') }}</th>
                                            <th scope="col">{{ __('Kebele') }}</th>
                                    ...
                                    <tbody>
                                        @foreach ($test as $test)
                                            <tr>
                                                ...
                                                <td>{{ $test->co_full_name }}</td>
                                                <td>{{ $test->co_company_name }}</td>
                                                <td>{{ $test->co_state }}</td>
                                                <td>{{ $test->co_city }}</td>
                                                <td>{{ $test->co_kebele }}</td>
                                                <td>{{ $test->co_relationship }}</td>
                                                <td>{{ $test->co_salary }}</td>
                                                <td>
