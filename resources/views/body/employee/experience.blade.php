...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>{{ __('Employee Experience') }}</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item text-capitalize"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                    <li class="breadcrumb-item active text-capitalize">{{ __('Employee Experience') }}</li>
                </ol>
            </nav>
        </div>
                                ...
                                @can('Personal_information access')
                                    <thead class="text-capitalize">
                                        <tr>
                                            ...
                                            <th scope="col">{{__('Previous Company')}}</th>
                                            <th scope="col">{{__('Period of Service')}}</th>
                                            <th scope="col">{{__('Relevant Experience')}}</th>
                                    ...
                                    <tbody>
                                        @foreach ($test as $test)
                                            <tr>
                                                ...
                                                <td>{{ $test->prev_company }}</td>
                                                <td>{{ $test->period_of_service }}</td>
                                                <td>{{ $test->relevant_experience }}</td>
                                                <td>
